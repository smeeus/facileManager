...
CREATE TABLE IF NOT EXISTS `$database`.`fm_{$__FM_CONFIG[$module]['prefix']}records` (
  ...
  `record_type` enum('A','AAAA','CAA','CERT','CNAME','DHCID','DLV','DNAME','DNSKEY','DS','HINFO','KEY','KX','MX','NAPTR','NS','NSEC3PARAM','OPENPGPKEY','PTR','RP','SRV','TLSA','TXT','SSHFP') NOT NULL DEFAULT 'A',
  ...
  `record_flags` enum('0','1','256','257','','U','S','A','P') DEFAULT NULL,
  `record_iterations` int(4) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `$database`.`fm_{$__FM_CONFIG[$module]['prefix']}servers` (
  ...
  `server_type` enum('bind9','remote') NOT NULL DEFAULT 'bind9',
...
('options', 'allow-update', '( address_match_element )', 'yes', 'OVZ', 'M', 'no', NULL),
...
('options', 'also-notify', '( ipv4_address | ipv6_address ) [ port ( ip_port | * ) ]', 'yes', 'OVZ', 'MS', 'no', NULL),
('options', 'alt-transfer-source', '( ipv4_address | * ) [ port ( ip_port | * ) ]', 'no', 'OVZ', 'MS', 'no', NULL),
('options', 'alt-transfer-source-v6', '( ipv6_address | * ) [ port ( ip_port | * ) ]', 'no', 'OVZ', 'MS', 'no', NULL),
...
('options', 'check-dup-records', '( fail | warn | ignore )', 'no', 'OVZ', 'M', 'yes', NULL),
('options', 'check-integrity', '( yes | no )', 'no', 'OVZ', 'M', 'yes', NULL),
('options', 'check-mx', '( fail | warn | ignore )', 'no', 'OVZ', 'M', 'yes', NULL),
('options', 'check-mx-cname', '( fail | warn | ignore )', 'no', 'OVZ', 'M', 'yes', NULL),
('options', 'check-names', '( warn | fail | ignore )', 'no', 'Z', 'MS', 'yes', NULL),
('options', 'check-names', '( master | slave | response | secondary ) ( warn | fail | ignore )', 'no', 'O', NULL, 'yes', NULL),
('options', 'check-sibling', '( yes | no )', 'no', 'OVZ', 'M', 'yes', NULL),
('options', 'check-spf', '( warn | ignore )', 'no', 'OVZ', 'M', 'yes', NULL),
('options', 'check-srv-cname', '( fail | warn | ignore )', 'no', 'OVZ', 'M', 'yes', NULL),
('options', 'check-wildcard', '( yes | no )', 'no', 'OVZ', 'M', 'yes', NULL),
...
('options', 'forward', '( first | only )', 'no', 'OVZ', 'MSF', 'yes', NULL),
('options', 'forwarders', '[ port ( ip_port | * ) ] { ( ipv4_address | ipv6_address ) } [ port ( ip_port | * ) ]', 'yes', 'OVZ', 'MSF', 'no', NULL),
...
('options', 'inline-signing', '( yes | no )', 'no', 'OZ', 'MS', 'yes', '9.9.0'),
('options', 'interface-interval', '( minutes )', 'no', 'O', NULL, 'no', NULL),
('options', 'ixfr-from-differences', '( yes | no | primary | master | secondary | slave )', 'no', 'OVZ', 'MS', 'yes', NULL),
...
('options', 'max-transfer-idle-out', '( minutes )', 'no', 'OVZ', 'MS', 'no', NULL),
('options', 'max-transfer-time-in', '( minutes )', 'no', 'OVZ', 'S', 'no', NULL),
('options', 'max-transfer-time-out', '( minutes )', 'no', 'OVZ', 'MS', 'no', NULL),
('options', 'max-udp-size', '( size_spec )', 'no', 'OSV', NULL, 'no', NULL),
('options', 'max-zone-ttl', '( unlimited | integer )', 'no', 'OZ', 'M', 'no', '9.11.0'),
...
('options', 'notify-source', '( ipv4_address | * ) [ port ( ip_port | * ) ]', 'no', 'OSVZ', 'MS', 'no', NULL),
('options', 'notify-source-v6', '( ipv6_address | * ) [ port ( ip_port | * ) ]', 'no', 'OSVZ', 'MS', 'no', NULL),
